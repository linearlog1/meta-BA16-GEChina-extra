...
echo "BBLAYERS += \" \${BSPDIR}/sources/meta-advantech-arm-extra \"" >> $BUILD_DIR/conf/bblayers.conf
echo "BBLAYERS += \" \${BSPDIR}/sources/meta-BA16-GEChina-extra\"" >> $BUILD_DIR/conf/bblayers.conf
